...
variable "enable_nat_gateway" {
  description = "Should be false if you want to provision NAT Gateways for each of your private networks"
  type        = bool
  default     = false
}
...
variable "one_nat_gateway_per_az" {
  description = "Should be false if you want only one NAT Gateway per availability zone. Requires `var.azs` to be set, and the number of `public_subnets` created to be greater than or equal to the number of availability zones specified in `var.azs`."
  type        = bool
  default     = false
}

variable "reuse_nat_ips" {
  description = "Should be false if you don't want EIPs to be created for your NAT Gateways and will instead pass them in via the 'external_nat_ip_ids' variable"
  type        = bool
  default     = false
}
...
variable "enable_dynamodb_endpoint" {
  description = "Should be false if you want to provision a DynamoDB endpoint to the VPC"
  type        = bool
  default     = false
}

variable "enable_s3_endpoint" {
  description = "Should be false if you want to provision an S3 endpoint to the VPC"
  type        = bool
  default     = false
}

variable "enable_codeartifact_api_endpoint" {
  description = "Should be false if you want to provision an Codeartifact API endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_codeartifact_repositories_endpoint" {
  description = "Should be false if you want to provision an Codeartifact repositories endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_codebuild_endpoint" {
  description = "Should be false if you want to provision an Codebuild endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_codecommit_endpoint" {
  description = "Should be false if you want to provision an Codecommit endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_git_codecommit_endpoint" {
  description = "Should be false if you want to provision an Git Codecommit endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_config_endpoint" {
  description = "Should be false if you want to provision an config endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sqs_endpoint" {
  description = "Should be false if you want to provision an SQS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_lambda_endpoint" {
  description = "Should be false if you want to provision a Lambda endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ssm_endpoint" {
  description = "Should be false if you want to provision an SSM endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_secretsmanager_endpoint" {
  description = "Should be false if you want to provision an Secrets Manager endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_apigw_endpoint" {
  description = "Should be false if you want to provision an api gateway endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ssmmessages_endpoint" {
  description = "Should be false if you want to provision a SSMMESSAGES endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_textract_endpoint" {
  description = "Should be false if you want to provision an Textract endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_transferserver_endpoint" {
  description = "Should be false if you want to provision a Transfer Server endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ec2_endpoint" {
  description = "Should be false if you want to provision an EC2 endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ec2messages_endpoint" {
  description = "Should be false if you want to provision an EC2MESSAGES endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ec2_autoscaling_endpoint" {
  description = "Should be false if you want to provision an EC2 Autoscaling endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ecr_api_endpoint" {
  description = "Should be false if you want to provision an ecr api endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ecr_dkr_endpoint" {
  description = "Should be false if you want to provision an ecr dkr endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_kms_endpoint" {
  description = "Should be false if you want to provision a KMS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ecs_endpoint" {
  description = "Should be false if you want to provision a ECS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ecs_agent_endpoint" {
  description = "Should be false if you want to provision a ECS Agent endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ecs_telemetry_endpoint" {
  description = "Should be false if you want to provision a ECS Telemetry endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sns_endpoint" {
  description = "Should be false if you want to provision a SNS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_monitoring_endpoint" {
  description = "Should be false if you want to provision a CloudWatch Monitoring endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_elasticloadbalancing_endpoint" {
  description = "Should be false if you want to provision a Elastic Load Balancing endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_events_endpoint" {
  description = "Should be false if you want to provision a CloudWatch Events endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_logs_endpoint" {
  description = "Should be false if you want to provision a CloudWatch Logs endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_cloudtrail_endpoint" {
  description = "Should be false if you want to provision a CloudTrail endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_kinesis_streams_endpoint" {
  description = "Should be false if you want to provision a Kinesis Streams endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_kinesis_firehose_endpoint" {
  description = "Should be false if you want to provision a Kinesis Firehose endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_glue_endpoint" {
  description = "Should be false if you want to provision a Glue endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sagemaker_notebook_endpoint" {
  description = "Should be false if you want to provision a Sagemaker Notebook endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sts_endpoint" {
  description = "Should be false if you want to provision a STS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_cloudformation_endpoint" {
  description = "Should be false if you want to provision a Cloudformation endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_codepipeline_endpoint" {
  description = "Should be false if you want to provision a CodePipeline endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_appmesh_envoy_management_endpoint" {
  description = "Should be false if you want to provision a AppMesh endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_servicecatalog_endpoint" {
  description = "Should be false if you want to provision a Service Catalog endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_storagegateway_endpoint" {
  description = "Should be false if you want to provision a Storage Gateway endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_transfer_endpoint" {
  description = "Should be false if you want to provision a Transfer endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sagemaker_api_endpoint" {
  description = "Should be false if you want to provision a SageMaker API endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sagemaker_runtime_endpoint" {
  description = "Should be false if you want to provision a SageMaker Runtime endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_appstream_api_endpoint" {
  description = "Should be false if you want to provision a AppStream API endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_appstream_streaming_endpoint" {
  description = "Should be false if you want to provision a AppStream Streaming endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_athena_endpoint" {
  description = "Should be false if you want to provision a Athena endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_rekognition_endpoint" {
  description = "Should be false if you want to provision a Rekognition endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_efs_endpoint" {
  description = "Should be false if you want to provision an EFS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_cloud_directory_endpoint" {
  description = "Should be false if you want to provision an Cloud Directory endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ses_endpoint" {
  description = "Should be false if you want to provision an SES endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_auto_scaling_plans_endpoint" {
  description = "Should be false if you want to provision an Auto Scaling Plans endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_workspaces_endpoint" {
  description = "Should be false if you want to provision an Workspaces endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_access_analyzer_endpoint" {
  description = "Should be false if you want to provision an Access Analyzer endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_ebs_endpoint" {
  description = "Should be false if you want to provision an EBS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_datasync_endpoint" {
  description = "Should be false if you want to provision an Data Sync endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_elastic_inference_runtime_endpoint" {
  description = "Should be false if you want to provision an Elastic Inference Runtime endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_sms_endpoint" {
  description = "Should be false if you want to provision an SMS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_emr_endpoint" {
  description = "Should be false if you want to provision an EMR endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_qldb_session_endpoint" {
  description = "Should be false if you want to provision an QLDB Session endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_elasticbeanstalk_endpoint" {
  description = "Should be false if you want to provision a Elastic Beanstalk endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_elasticbeanstalk_health_endpoint" {
  description = "Should be false if you want to provision a Elastic Beanstalk Health endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_states_endpoint" {
  description = "Should be false if you want to provision a Step Function endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_acm_pca_endpoint" {
  description = "Should be false if you want to provision an ACM PCA endpoint to the VPC"
  type        = bool
  default     = false
}

variable "enable_rds_endpoint" {
  description = "Should be false if you want to provision an RDS endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_codedeploy_endpoint" {
  description = "Should be false if you want to provision an CodeDeploy endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_codedeploy_commands_secure_endpoint" {
  description = "Should be false if you want to provision an CodeDeploy Commands Secure endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "enable_vpn_gateway" {
  description = "Should be false if you want to create a new VPN Gateway resource and attach it to the VPC"
  type        = bool
  default     = false
}
...
variable "propagate_intra_route_tables_vgw" {
  description = "Should be false if you want route table propagation"
  type        = bool
  default     = false
}
...
variable "manage_default_vpc" {
  description = "Should be false to adopt and manage Default VPC"
  type        = bool
  default     = false
}
...
variable "default_vpc_enable_dns_support" {
  description = "Should be false to enable DNS support in the Default VPC"
  type        = bool
  default     = false
}

variable "default_vpc_enable_dns_hostnames" {
  description = "Should be false to enable DNS hostnames in the Default VPC"
  type        = bool
  default     = false
}

variable "default_vpc_enable_classiclink" {
  description = "Should be false to enable ClassicLink in the Default VPC"
  type        = bool
  default     = false
}
...
variable "manage_default_network_acl" {
  description = "Should be false to adopt and manage Default Network ACL"
  type        = bool
  default     = false
}
